...
document.addEventListener("DOMContentLoaded", () => {
	...
	activatedSliders("#content-3 .slider");
  });
  ...
  sights.addEventListener('click', function() {
	tab2.click();
  });
  ...
  const tabFocus = document.querySelectorAll('.slider__text');
 ...
 const btnNext = document.querySelectorAll('.slider__carousel .slider__control[data-slide=next]');
 const btnPrev = document.querySelectorAll('.slider__carousel .slider__control[data-slide=prev]');
 const next_button = document.querySelector('._icon-point_right');
 const prev_button = document.querySelector('._icon-point_left');
...
const btnNextNew = document.querySelector('.main-slider[data-slide="next"]');
const btnPrevNew = document.querySelector('.main-slider[data-slide="prev"]');
const next_buttonNew = document.querySelector('.main-img__point.left');
const prev_buttonNew = document.querySelector('.main-img__point.right');

next_buttonNew.addEventListener('click', function() {
btnNextNew.click();
	});
prev_buttonNew.addEventListener('click', function() {
   btnPrevNew.click();
   });
    ...
    options: {
        ...
        scales: {
			x: {
				...
				grid: {
					display: false,
					borderColor: 'rgba(245, 244, 249, 1)',
				},
				ticks: {
